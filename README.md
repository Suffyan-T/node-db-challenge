...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
	Relational databases have information stored within tables and columns.
	SQL is a language used to acess and modify databases

- [ ] Why do tables need a `primary key`?

	Because they need a unique identifier for each entery
...
- [ ] What do we need in order to have a _many to many_ relationship between two tables.
	...
	We need multiple relationships between two tables
